This is a block list of sites that can be added to your browser/extensions to block ai features. 

# Intended Options
## uBlock Origin
Because I use Firefox and Qutebrowser, I am unsure if this will work on Chrome/Chromium based browsers.
